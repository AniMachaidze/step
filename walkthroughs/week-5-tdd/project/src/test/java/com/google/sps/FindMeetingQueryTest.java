...
public final class FindMeetingQueryTest {
    ...
    public void everyAttendeeIsConsidered() {
        ...
        Collection<Event> events = Arrays.asList(
            new Event("Event 1", TimeRange
                .fromStartDuration(TIME_0800AM, DURATION_30_MINUTES),
                Arrays.asList(PERSON_A)),
            new Event("Event 2", TimeRange
                .fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
    ...
    public void overlappingEvents() {
        ...
        Collection<Event> events = Arrays.asList(
            new Event("Event 1", TimeRange
                .fromStartDuration(TIME_0830AM, DURATION_60_MINUTES),
                Arrays.asList(PERSON_A)),
            new Event("Event 2", TimeRange
                .fromStartDuration(TIME_0900AM, DURATION_60_MINUTES),
                Arrays.asList(PERSON_B)));
    ...
    public void nestedEvents() {
        ...
        Collection<Event> events = Arrays.asList(
            new Event("Event 1", TimeRange
                .fromStartDuration(TIME_0830AM, DURATION_90_MINUTES), Arrays.asList(PERSON_A)),
            new Event("Event 2", TimeRange
                .fromStartDuration(TIME_0900AM, DURATION_30_MINUTES),
                Arrays.asList(PERSON_B)));
    ...
    public void justEnoughRoom() {
        ...
        Collection<Event> events = Arrays.asList(
            new Event("Event 1", TimeRange
                .fromStartEnd(TimeRange.START_OF_DAY, TIME_0830AM, false),
                Arrays.asList(PERSON_A)),
            new Event("Event 2", TimeRange
                .fromStartEnd(TIME_0900AM, TimeRange.END_OF_DAY, true),
                Arrays.asList(PERSON_A)));
    ...
    public void ignoresPeopleNotAttending() {
        ...
        Collection<Event> events = Arrays.asList(new Event("Event 1", TimeRange
            .fromStartDuration(TIME_0900AM, DURATION_30_MINUTES), Arrays.asList(PERSON_A)));
        MeetingRequest request = new MeetingRequest(Arrays.asList(PERSON_B),
            DURATION_30_MINUTES);
    ...
    public void optionalAttendeeCantAttend() {
        ...
        Collection<TimeRange> actual = query.query(events, request);
        Collection<TimeRange> expected =
            Arrays.asList(TimeRange.fromStartEnd(TimeRange
                    .START_OF_DAY, TIME_0800AM, false),
                TimeRange.fromStartEnd(TIME_0830AM, TIME_0900AM, false),
                TimeRange.fromStartEnd(TIME_0930AM, TimeRange.END_OF_DAY, true));
    ...
    public void justEnoughRoomForOptionalAttendee() {
        ...
        Collection<Event> events = Arrays.asList(
            ...
            new Event("Event 3", TimeRange
                .fromStartEnd(TIME_0830AM, TIME_0845AM, false),
                Arrays.asList(PERSON_B)));
    ...
    public void onlyOptionalAttendees() {
        ...
        Collection<Event> events = Arrays.asList(
            new Event("Event 1", TimeRange
                ...
                Arrays.asList(PERSON_A)),
            new Event("Event 2", TimeRange
                .fromStartDuration(TIME_0930AM, DURATION_30_MINUTES),
                Arrays.asList(PERSON_B)));

        MeetingRequest request = new MeetingRequest(NO_ATTENDEES,
            DURATION_30_MINUTES);
    ...
    public void noTimeWithOnlyOptionals() {
        ...
        Collection<Event> events = Arrays.asList(
            new Event("Event 1", TimeRange
                ...
                Arrays.asList(PERSON_A)),
            new Event("Event 2", TimeRange
                .fromStartEnd(TIME_0830AM, TimeRange.END_OF_DAY, true),
                Arrays.asList(PERSON_B)));
